...
<div class="board_area w-100 border m-auto d-flex">
  ...
  <div class="other_area w-25">
    <div class="m-4">
      <div class="post_submit"><a href="{{ route('post.input') }}" class="post-submit-btn">投稿</a></div>
      ...
      <ul class="category_list">
        ...
        <li class="main_category" category_id="{{ $category->id }}">
          ...
          <ul class="sub_category_list" style="display: none;">
            ...
            <li class="sub_category_title"><a href="{{ route('post.by.sub_category', $subCategory->id) }}">{{ $subCategory->sub_category ?? '未設定' }}</a></li>
            @endforeach
          </ul>
          @endif
        </li>
