...
<div class="search_content w-100  d-flex">
  ...
  <div class="search_area w-25">
    <div class="">
      ...
      <div>
        <lavel class="search-condition">カテゴリ</lavel>
      ...
      <div class="">
        <p class="m-0 search_conditions"><span class="search-addition">検索条件の追加</span><i class="arrow-icon fas fa-chevron-down"></i></p>
